...
import { CreditCard, Smartphone, CheckCircle, XCircle, Zap, ShieldCheck, AlertCircle, Copy } from 'lucide-react';
...
export function AddMoney({ initialAmount = '', onSuccess }: AddMoneyProps) {
  ...
  const [selectedUpiVpa, setSelectedUpiVpa] = useState(() => {
    const vpas = ['s5698564172094253@slc'];
  ...
  const handlePrimaryPayment = async () => {
    // Use UPI Payment as the primary service
