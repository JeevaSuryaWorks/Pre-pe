            ...
            <div className="min-h-screen flex flex-col lg:flex-row bg-slate-50/50 relative overflow-hidden grid-bg">
                ...
                <div ref={formSectionRef} className="flex-1 flex items-center justify-center p-4 sm:p-8 lg:p-12 relative z-10">
                    <div className="w-full max-w-md space-y-6 relative">
                        ...
                        <div className="relative group/card p-[1.5px] rounded-[34px] bg-gradient-to-b from-slate-200 to-slate-100 hover:from-[#FF671F]/20 hover:to-[#046A38]/20 transition-all duration-500 shadow-2xl shadow-slate-100/70 animate-in fade-in slide-in-from-bottom-4 duration-500">
                            <Card className="border-none shadow-none bg-white rounded-[32px] overflow-hidden">
                                <CardContent className="p-6 sm:p-8">
                                    <div className="hidden lg:block mb-4">
                                        ...
                                        <p className="text-xs text-slate-400 font-medium mt-1">Enter your details to create an account</p>
                                    </div>
                                    <RegisterForm />
                                </CardContent>
                            </Card>
